        ...
        <div class="modal-container">
          ...
          <div class="modal-content">
            ...
            <div v-if="step === 'amount'" class="step-amount">
              <p class="step-description">Digite o valor que deseja depositar:</p>
            ...
            <div v-if="step === 'payment'" class="step-payment">
              <div class="payment-info">
                <p class="payment-amount">Valor: <strong>{{ formatAmount(amount) }}</strong></p>
                <p class="payment-id">ID: {{ depositData?.transaction_id }}</p>
              </div>
              ...
              <!-- Confirm Button -->
              <button class="submit-btn success" @click="handleConfirm">
            ...
            <div v-if="step === 'success'" class="step-success">
              ...
              <h3 class="success-title">Pagamento em processamento!</h3>
              <p class="success-description">
                Seu depósito de <strong>{{ formatAmount(amount) }}</strong> está sendo processado.
                O saldo será atualizado em alguns instantes.
              </p>
