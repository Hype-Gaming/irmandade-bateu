<template>
  <div class="jogo-page" :style="themeStyles" :class="{ 'aviator-theme': isAviator }">
    ...
    <a
      ...
      class="live-banner"
    >
      <img src="/banners/live.png?v=2" alt="Clique para participar da live hoje às 20:00" />
    </a>
...
const catalogadorUi = computed(() => {
  switch (gameId.value) {
    ...
    case 'football-studio':
      return {
        historyTitle: 'Histórico do Football Studio',
        resultsTitle: 'Últimos resultados',
        statsTitle: 'Estatísticas da partida',
        strategyTitle: 'Estratégias do Football Studio',
        ...
        predictionLabel: 'Próxima entrada:',
        closeLabel: 'Fechar Football Studio',
        unavailableTitle: 'Football Studio indisponível',
        unavailableDescription: 'Faça login para acessar o Football Studio',
        loginLabel: 'Entrar para jogar'
      }
    case 'dragon-tiger':
      return {
...
const themeStyles = computed(() => {
  ...
  if (gameId.value === 'football-studio') {
    return {
      '--accent-color': '#dc2626',
      '--player-color': '#dc2626',
