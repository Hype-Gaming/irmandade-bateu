  ...
  <div class="aulas-page">
    ...
    <div class="content">
      <div class="page-title">
        ...
        <h1>Aulas</h1>
        <p>Aprenda as melhores estratégias com nossos conteúdos exclusivos</p>
      </div>

      <div class="videos-grid">
        <div v-for="(aula, index) in aulas" :key="index" class="video-card">
...
useHead({
  title: 'Aulas - Irmandade Club'
})

const aulas = [
  {
    title: 'Boas Vindas',
    description: 'Introdução ao Irmandade Club e como aproveitar ao máximo a plataforma.',
