      ...
      <div class="content-wrapper">
          ...
          <div class="header-container">
            <div class="header-content">
              <div class="header-text">
                <h1 class="page-title">
                  Gestão de <span class="gradient-text">Banca</span>
                </h1>
                <p class="page-subtitle">Calcule sua estratégia financeira para 30 dias de forma inteligente</p>
              </div>
            </div>
            ...
            <div class="stats-preview" v-if="resultados.length > 0">
              <div class="stat-item">
                ...
                <span :class="['stat-value', getLucroClass]">
                  {{ ((resultados[resultados.length - 1].finalBanca - bancaInicial) / bancaInicial * 100).toFixed(2) }}%
                </span>
              </div>
            </div>
          </div>
            ...
            <div class="calculator-card">
              <div class="card-header">
                <div class="card-header-content">
                  <div>
                    ...
                    <span class="card-subtitle">Configure sua estratégia de gestão</span>
                  </div>
                </div>
              </div>
              ...
              <div class="input-grid">
                ...
                <div class="input-group">
                  ...
                  <div class="input-hint">Valor inicial da sua banca</div>
                </div>
                ...
                <div class="input-group">
                  ...
                  <div class="input-hint">Percentual de ganho diário</div>
                </div>
                ...
                <div class="input-group">
                  ...
                  <div class="input-hint">Perda máxima aceitável</div>
                </div>
              </div>
              ...
              <div class="tips-grid">
                <div class="tip-item">
                  ...
                  <div class="tip-content">
                    ...
                    <p>3-5% ao dia é ideal para iniciantes</p>
                  </div>
                </div>
                <div class="tip-item">
                  <div class="tip-icon">
                  ...
                  <div class="tip-content">
                    ...
                    <p>Mantenha entre 5-10% para proteger seu capital</p>
                  </div>
                </div>
                <div class="tip-item">
                  <div class="tip-icon">
                  ...
                  <div class="tip-content">
                    <h4>Disciplina</h4>
                    <p>Siga rigorosamente seu plano de gestão</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section v-if="resultados.length > 0" class="results-section">
          <div class="results-container">
            ...
            <div v-if="savedDateInfo" class="data-status">
              <div class="status-content">
                <div class="status-info">
                  ...
                  <div>
                    <span class="status-label">Dados salvos em</span>
                    <span class="status-value">{{ savedDateInfo.date }}</span>
                  </div>
                </div>
                <div class="status-expiry">
                  <Icon name="ph:hourglass-bold" />
                  <span>Expira em {{ savedDateInfo.daysRemaining }} dias</span>
                </div>
                <button @click="clearSavedData" class="clear-data-btn">
            ...
            <div class="summary-cards">
              <div class="summary-card initial">
                ...
                <div class="summary-content">
                  <span class="summary-label">Banca Inicial</span>
                  <span class="summary-value">R$ {{ bancaInicial.toFixed(2) }}</span>
                </div>
              </div>
              ...
              <div class="summary-card final">
                ...
                <div class="summary-content">
                  <span class="summary-label">Banca Final</span>
                  <span class="summary-value">R$ {{ resultados[resultados.length - 1].finalBanca.toFixed(2) }}</span>
                </div>
              </div>

              <div class="summary-card profit" :class="getLucroClass">
                <div class="summary-icon">
                  <Icon :name="(resultados[resultados.length - 1].finalBanca - bancaInicial) >= 0 ? 'ph:trend-up-bold' : 'ph:trend-down-bold'" />
                </div>
                <div class="summary-content">
                  <span class="summary-label">Lucro/Prejuízo</span>
                  <span class="summary-value">R$ {{ (resultados[resultados.length - 1].finalBanca - bancaInicial).toFixed(2) }}</span>
                </div>
              </div>

              <div class="summary-card roi" :class="getLucroClass">
                <div class="summary-icon">
                  <Icon name="ph:percent-bold" />
                </div>
                <div class="summary-content">
                  <span class="summary-label">Rentabilidade</span>
                  <span class="summary-value">{{ ((resultados[resultados.length - 1].finalBanca - bancaInicial) / bancaInicial * 100).toFixed(2) }}%</span>
                </div>
              </div>
            </div>
            ...
            <div class="days-header">
              ...
              <p>Clique nos botões para simular resultados de cada dia</p>
            </div>
            ...
            <div class="days-grid">
              ...
              >
                <div class="day-header">
                  <span class="day-number">Dia {{ dia.dia }}</span>
                  <div class="day-status">
                    <Icon v-if="dia.resultado === 'green'" name="ph:check-circle-bold" class="status-green" />
                    <Icon v-else-if="dia.resultado === 'loss'" name="ph:x-circle-bold" class="status-loss" />
                    <Icon v-else name="ph:clock-bold" class="status-pending" />
                  </div>
                </div>
                ...
                <div class="day-content">
                  <div class="banca-info">
                    ...
                    <span class="banca-value">R$ {{ dia.bancaInicial.toFixed(2) }}</span>
                  </div>

                  <div class="targets">
                    <div class="target-item win" @click="startEditing(index, 'win')">
                      <span class="target-label">
                        <Icon name="ph:arrow-up-bold" />
                        Win
                      </span>
                      <span class="target-value" v-if="!(editing.index === index && editing.field === 'win')">
                        R$ {{ dia.stopWin.toFixed(2) }}
                      </span>
                      <input
                        v-if="editing.index === index && editing.field === 'win'"
                    ...
                    <div class="target-item loss" @click="startEditing(index, 'loss')">
                      <span class="target-label">
                        <Icon name="ph:arrow-down-bold" />
                        Loss
                      </span>
                      <span class="target-value" v-if="!(editing.index === index && editing.field === 'loss')">
                        R$ {{ dia.stopLoss.toFixed(2) }}
                      </span>
                      <input
                        v-if="editing.index === index && editing.field === 'loss'"
                        v-model.number="editValue"
                        type="number"
                        class="target-input"
                        @blur="finishEditing(index)"
                  ...
                  <div class="day-actions">
                    <button 
                      @click="setResultado(index, 'green')"
                      class="action-button green"
                      :class="{ active: dia.resultado === 'green' }"
                    >
                    ...
                    <button 
                      ...
                      :class="{ active: dia.resultado === 'loss' }"
                    >
                      <Icon name="ph:x-bold" />
                      Loss
                    </button>
                  ...
                  <div class="day-final">
                    ...
                    <span class="final-value" :class="dia.resultado">
        ...
        <section v-else class="empty-state">
          <div class="empty-content">
            ...
            <p>Preencha os parâmetros acima e clique em "Calcular Gestão" para visualizar sua estratégia de 30 dias</p>
          </div>
        </section>
      </div>
    </main>
...
const getLucroClass = computed(() => {
  ...
  const lucro = resultados.value[resultados.value.length - 1].finalBanca - bancaInicial.value
...
const calcular = () => {
  ...
  if (resultados.value.length > 0) {
    if (confirm('Você já possui uma gestão em andamento. Deseja criar uma nova e substituir a atual?')) {
      performCalculation()
    }
  } else {
    performCalculation()
...
const startEditing = (index: number, field: string) => {
  ...
  editValue.value = field === 'win' ? resultados.value[index].stopWin : resultados.value[index].stopLoss
}
...
const saveData = () => {
  ...
  const dataToSave = {
    ...
    createdAt: savedDate.value ? savedDate.value.toISOString() : now.toISOString(),
